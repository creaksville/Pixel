...
module.exports = {
    ...
    async execute(emoji, guild, client) {
        try {
            ...
            const emojisUpdateChannel = channelRecordRow[0]?.guildEmojisCreate;
            ...
            const existingEnableRecord = enableRecordRow[0]?.guildEmojisCreate;
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`:white_check_mark: **Emoji Created in ${emoji?.guild.name}**`)
                .addFields(
